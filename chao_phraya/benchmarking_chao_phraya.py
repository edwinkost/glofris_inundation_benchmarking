...
def contingency_default(bench_fn, model_fn, bench_thres, model_thres, mask_fn, urban_fn, masking=False, urban_masking=False):
...
model_fn = "/scratch-shared/edwinsut/finalizing_downscaling/using_strahler_order_3/global/maps/inun_25-year_of_channel_storage_catch_03.tif.map.masked_out.map"
