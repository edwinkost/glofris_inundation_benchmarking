...
bench_fn = r'c:\Users\hcwin\OneDrive\IVM\2017\paper_costs\benchmarks\Bangkok\inun_bangkok.tif'
model_fn = r'c:\Users\hcwin\OneDrive\IVM\2017\paper_costs\benchmarks\Bangkok\bangkok_rp25.tif'
mask_fn = r'c:\Users\hcwin\OneDrive\IVM\2017\paper_costs\benchmarks\Bangkok\mask_bangkok_chaophraya.tif'
urban_fn = r'c:\Users\hcwin\OneDrive\IVM\2017\paper_costs\urban_2010\landuse_1_base_2010.tif'
model_warp_fn = r'c:\Users\hcwin\OneDrive\projects\1209884_GFRA\benchmark\inun_dynRout_RP_00100_warp.tif'
...
hr, far, csi, x, y, cont_arr_urban, flood1, flood2 = contingency(bench_fn, model_fn, 0.5, 0., mask_fn, urban_fn, masking=True, urban_masking=True)
...
plot_contingency(x, y, np.flipud(cont_arr_urban), 'Bangkok')
plt.savefig('Bangkok_urban_only.png', dpi=300, bbox_inches='tight')
