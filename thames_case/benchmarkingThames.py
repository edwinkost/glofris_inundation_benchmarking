...
model_fn     = "/scratch-shared/edwinsut/finalizing_downscaling/using_strahler_order_3/global/maps/inun_100-year_of_channel_storage_catch_03.tif.map.masked_out.map"
...
title = "Thames"
hr, far, csi, x, y, cont_arr, flood1, flood2 = contingency(bench_fn, model_fn, 0.00, 0., mask_fn, title, masking = True, clone_map = clone_map)
