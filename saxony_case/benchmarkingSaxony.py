...
model_fn = "/scratch-shared/edwinsut/finalizing_downscaling/using_strahler_order_2/global/maps/inun_100-year_of_channel_storage_catch_02.tif.map.masked_out.map" # r'c:\Users\hcwin\OneDrive\IVM\2017\paper_costs\benchmarks\Saxony\inun_dynRout_Saxony_MASKED.tif'
...
hr, far, csi, x, y, cont_arr = contingency(bench_fn, model_fn, 0.5, 0., mask_fn, "Saxony", masking = True)
